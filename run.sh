USER=`whoami`
echo -e "\e[32m                  ..,rO@@hrr ... \e[0m."
echo -e "\e[32m                                  .e[0m."
echo -e "\e[32m         .i(                          j\        .::^^^^::.. \e[0m"
...
echo -e "\e[32m            .no*bdbdbdbbdz                                 n]+~+~+-jjkjf?~+~+~+f- \e[0m"
...
echo -e "\e[32m      :-obdbdbdbdbdbdbdbdbdbdbddi                     /+~+~r+~+~+~+~+~+~+~+~+~+~| \e[0m"
